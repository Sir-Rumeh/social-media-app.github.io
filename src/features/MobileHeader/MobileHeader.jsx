...
function MobileHeader() {
	return (
		<div className="md:hidden flex  items-center align-middle justify-between w-full p-2 ">
			...
			<form action="" className="">
				<div className="flex items-center text-gray-400 focus-within:text-gray-600 ">
					<input
						...
						className=" placeholder-gray-500 text-black border-none focus:ring-gray-500 focus:ring-2 w-[21rem] -ml-4 pl-10 h-10"
					/>
					<svg
						width="16"
						height="16"
